                ...
                >
                  <div className="footer-widget-two__about">
                    ...
                    <p className="footer-widget-two__about-text">
                      Plant a tree today and give the planet cleaner air
                      tomorrow
                  ...
                  <div className="footer-widget-two__contact">
                    ...
                    <ul className="footer-widget-two__contact-list list-unstyled">
                      <li>
                        ...
                        <p>
                          <Link href="tel:0882466422710">+91 99-1131-4655</Link>
                        </p>
                      </li>
                      <li>
                        <div className="icon">
                        ...
                        <p>
                          <Link href="mailto:info@ldrfoundation.com">
                            info@ldrfoundation.com
                          </Link>
                        </p>
                      </li>
                    </ul>
                  ...
                  <div className="site-footer-two__bottom-inner">
                    <div className="site-footer-two__copyright">
                      <p className="site-footer-two__copyright-text">
                        Copywright 2024 by <Link href="#">Anity</Link>. All
                        Rights Reserved.
                      </p>
                    </div>
