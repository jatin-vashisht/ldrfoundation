...
const causesData = {
  1: {
    ...
    description:
      "Your donation plants trees and you receive monthly updates on their growth",
    ...
    percentage: "57%",
    longDescription:
      "Every rupee you donate goes directly towards planting more trees in areas that need reforestation the most. When you contribute to our plantation initiative, you're not just making a donation - you're adopting trees that will grow and thrive for generations to come.",
    detailedText:
      "Here's what makes our program special: After you donate, we plant native trees in your name and provide you with regular monthly updates about your trees' progress. You'll receive photos, growth measurements, and health reports showing exactly how your contribution is making a real environmental impact. Watch your trees grow from saplings to mature forest guardians!",
    goals: [
  ...
  2: {
    ...
    category: "health",
    description:
      "Providing clean drinking water and nutritious meals to children in underserved communities",
    ...
    percentage: "67%",
    longDescription:
      "Access to clean water and nutritious food is a basic human right. Our program ensures that children in underserved communities receive safe drinking water and balanced meals for healthy development.",
    detailedText:
      "Many children around the world lack access to clean water and proper nutrition. Every day, waterborne diseases affect thousands of children, while malnutrition stunts their growth and development.",
    goals: [
  ...
  3: {
    ...
    category: "education",
    description:
      "Providing quality education and learning resources to underprivileged children across India",
    ...
    percentage: "82%",
    longDescription:
      "We provide quality education and learning resources to underprivileged children across India. Our mission is to ensure that every child has access to basic education and the opportunity for a brighter future.",
    detailedText:
      "Education is the foundation of progress and development. Many children in rural and underserved areas lack access to quality education due to poverty, lack of infrastructure, and inadequate resources. We bridge this gap by building schools, training teachers, and providing educational materials.",
    goals: [
            ...
            <div className="row">
              <div className="col-xl-8 col-lg-7">
                <div className="cause-details__left">
                  ...
                  <div className="cause-details__progress-box">
                    ...
                    <div className="cause-details__goals">
                      <div className="cause-details__raised">
                        <p>
                          <i className="fal fa-donate"></i>
                          {cause.percentage} <span>Raised</span>
                        </p>
                      </div>
                      <div className="cause-details__raised">
                        <p>
                          <i className="far fa-analytics"></i> {cause.goal}
                          <span>Goal</span>
                        </p>
                      </div>
                    </div>
                  ...
                  {customAmount && (
                    <div
                      className="cause-details__custom-amount"
                  ...
                  <div className="cause-details__pament-box">
                    <h2 className="cause-details__pament-title">
                    ...
                    >
                      <div className="row">
                        <div className="col-xl-6 col-lg-6">
                          <h4 className="cause-details__input-title">
                            First Name
                          </h4>
                  ...
                  <div className="cause-details__donate-and-btn">
                    <h4 className="cause-details__donate-title">
                      Donation Total:
                    </h4>
                  ...
                  <p className="cause-details__text-1">
                    {cause.longDescription}
                  </p>
                  <p className="cause-details__text-2">{cause.detailedText}</p>
                  <p className="cause-details__text-3">
                    Join us in making a difference. Your contribution, no matter
                    how small, helps us achieve our mission and create lasting
                    positive impact in communities that need it most.
                  </p>
                  ...
                  <p className="cause-details__text-4">
                    We believe in creating sustainable change through targeted
                    interventions.{" "}
                    <span className="color-black">
                      Together we can make a difference.
                    </span>{" "}
                    If you can contribute{" "}
                    <span className="color-base">any amount in rupees</span>, it
                    will help us reach our goals.
                  </p>
                  <p className="cause-details__text-5">
                    Our comprehensive approach ensures that every donation
                    creates maximum impact. We work directly with communities to
                    understand their needs and implement solutions that create
                    lasting change.
                  </p>
                ...
                <div className="sidebar">
                    ...
                    <ul className="sidebar__category-list list-unstyled">
                      <li>
                        <Link href="/cause-details/1">
                          Plantation & Environment<span>25</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="/cause-details/2">
                          Clean Water & Food<span>35</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="/cause-details/3">
                          Education & Learning<span>42</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="/donation">
                          Fundraising Events<span>18</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="/volunteer">
                          Volunteer Programs<span>28</span>
                        </Link>
                      </li>
                      <li>
                        <Link href="/about">
                          Community Outreach<span>33</span>
                        </Link>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="sidebar__single sidebar__call-to-action">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          " url(assets/images/project/sidebar-call-to-action-bg.jpg)",
                      }}
                    ></div>
                    <span className="sidebar__call-to-action-sub-title">
                      Call To Action
                    </span>
                    <h3 className="sidebar__call-to-action-title">
                      Together we can make a difference
                    </h3>
